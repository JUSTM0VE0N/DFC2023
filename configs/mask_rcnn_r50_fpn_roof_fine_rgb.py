...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='CocoDataset',
            ann_file='./data/dfc_root/annotations/roof_fine_train.json',
            img_prefix='./data/dfc_root/train/rgb/',
            pipeline=[
                dict(type='LoadImageFromFile'),
                dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
                dict(
    ...
    val=dict(
        type='CocoDataset',
        ann_file='./data/dfc_root/image_id/image_id_val.json',
        img_prefix='./data/dfc_root/val/rgb/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
CLASSES = ('flat_roof', 'gable_roof', 'gambrel_roof', 'row_roof',
           'multiple_eave_roof', 'hipped_roof_v1', 'hipped_roof_v2',
           'mansard_roof', 'pyramid_roof', 'arched_roof', 'revolved', 'other')
